...
-->
       ...
       <xsl:if test="marc:datafield[@tag=020]">
        ...
        <span class="results_summary other_editions"><span class="label">Other Language Version: </span>
        <xsl:for-each select="marc:datafield[@tag=775]">
            ...
            <xsl:when test="$UseControlNumber = '1' and marc:subfield[@code='o']">
                <xsl:attribute name="href">/cgi-bin/koha/catalogue/search.pl?q=kw:<xsl:value-of select="marc:subfield[@code='o']"/></xsl:attribute>
            </xsl:when>
            <xsl:when test="$UseControlNumber = '1' and marc:subfield[@code='w']">
                <xsl:attribute name="href">/cgi-bin/koha/catalogue/search.pl?q=Control-number:<xsl:call-template name="extractControlNumber"><xsl:with-param name="subfieldW" select="marc:subfield[@code='w']"/></xsl:call-template></xsl:attribute>
            </xsl:when>
        ...
        <xsl:text> </xsl:text>
            ...
            <xsl:choose>
                <xsl:when test="$UseControlNumber = '1' and marc:subfield[@code='o']">
                    <a><xsl:attribute name="href">/cgi-bin/koha/catalogue/search.pl?q=kw:<xsl:value-of select="marc:subfield[@code='o']"/></xsl:attribute>
                    </a>
                </xsl:when>
                <xsl:when test="$UseControlNumber = '1' and marc:subfield[@code='w']">
                    <a><xsl:attribute name="href">/cgi-bin/koha/catalogue/search.pl?q=Control-number:<xsl:call-template name="extractControlNumber"><xsl:with-param name="subfieldW" select="marc:subfield[@code='w']"/></xsl:call-template></xsl:attribute>
        ...
        <span class="results_summary"><span class="label">Other Form: </span>
